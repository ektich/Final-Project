...
public class ProjectServiceImpl implements ProjectService {
    ...
    @Override
    public int updateSingleProject(int pid, int sid, Boolean cancel) {
        if(cancel) {
            return projectDao.updateSingleProject2(pid, 0);
        } else {
            return projectDao.updateSingleProject2(pid, sid);
        }
    }
    ...
    public int deleteStudent(int pid, int sid) {
        ...
        return projectDao.updateSingleProject3(pid, deleteStudentUtil(content, sid));
    }
