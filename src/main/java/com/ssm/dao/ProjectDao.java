...
public interface ProjectDao {
    ...
    /**
     * designate project to certain student
     * @param pid project id
     * @param candidates student id
     * @return Result<int>
     */
    int cancelCandidate(@Param(value = "pid") int pid, @Param(value = "candidates") String candidates);
     ...
     */
    int concatCandidate(@Param(value = "pid") int pid, @Param(value = "candidates") String candidates);
